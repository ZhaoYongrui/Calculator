...
//        btn_percent.setOnClickListener(this);
    ...
    public void onClick(View v) {
        //点击动作
        String str = text.getText().toString();//获取文本区输入的内容
        switch(v.getId()){
            case R.id.btn_del://回退删除键
                if(str.length()>1){
            ...
            case R.id.btn_9:
                ...
                break;
            case R.id.btn_p://小数点
                if(str == ""||str.charAt(str.length()-1)=='+'||str.charAt(str.length()-1)=='-'||str.charAt(str.length()-1)=='×'||str.charAt(str.length()-1)=='÷'||str.charAt(str.length()-1)=='.'){
            ...
            case R.id.btn_equ://等号
                ...
                break;
            case R.id.btn_squ2://开平方
                if(str.charAt(0)=='-'){
                    Toast.makeText(MainActivity.this,"负数不能开根号！",Toast.LENGTH_SHORT).show();
                    text.setText("0");
                }
                else if(str.contains("+")||str.contains("-")||str.contains("×")||str.contains("÷")){
                    Toast.makeText(MainActivity.this,"运算符不能开根号！",Toast.LENGTH_SHORT).show();
                    text.setText("0");
                }
                else{
...
//                break;
    ...
    public String getResult(){
        ...
        StringBuffer postfix=toPostfix(infix);//把中缀表达式转换成后缀表达式
